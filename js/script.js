...
/***** menu today *****/
let now = new Date(); /* 현재 날짜 및 시각 */
document.getElementById("monthMainMenu").textContent = now.getMonth() + 1;
document.getElementById("dateMainMenu").textContent = now.getDate();
document.getElementById("monthProjectMenu").textContent = now.getMonth() + 1;
document.getElementById("dateProjectMenu").textContent = now.getDate();
...
function showPopup() {
  ...
  // 줄바꿈 단위로 <p class="fortuneball-quote"> 생성
  randomMsg.split("\n").forEach((line) => {
